...
This leads to an interesting insight: just as competitors can end up looking a lot like one another on features/pricing, so can they in terms of structure.
A market made up of firms offering manifestly similar products is often considered stagnant, and thus a potential opportunity for disruption.
I think the same is true when those firms have very similar structures - they probably all have similar biases, blindspots, and weaknesses - thus there's likely to be unexplored avenues for them to improve or be disrupted.
